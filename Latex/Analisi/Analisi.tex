...
Trovati quindi modello e momento, come mostrato prima, è stato reiterato il processo di training, allenando la rete per altre 200 epoche e calcolando la ROC Curve, riportata in Figura \ref{Roc}.
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{Analisi/ROCCurve.jpg}
    \caption{ROC curve ottenuta per il modello ottimizzato: \textit{Learning Rate}=0.0001, Momentum=0.6}
    \label{Roc}
\end{figure}