...
\begin{itemize}
    \item Classificare correttamente i segnali rilevati in tre macrocategorie semantiche: \textit{Indicazione}, \textit{Pericolo}, \textit{Divieto}, \textit{Background};
...
\begin{itemize}
    \item \textbf{LR 0.0001}: Fallimentare per tutti i valori di momentum (Acc $\approx$ 0.1-0.2).
